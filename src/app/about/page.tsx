...
export default function AboutPage() {
  return (
    <div className="py-8 px-4 max-w-2xl mx-auto pb-24">
      ...
      <h1 className="text-2xl font-bold mb-4 text-foreground">About JalaForum</h1>
      <p className="leading-relaxed text-muted-foreground">
        JalaForum is the discussion and community hub in the JalaJO ecosystem — a forum for sharing posts with text, images, and music.
